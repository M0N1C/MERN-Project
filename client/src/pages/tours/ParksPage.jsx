...
function ParksPage() {
  ...
  return (
    <div className="container mx-auto py-20">
      <h1 className="text-4xl font-bold text-gray-900 mb-6">Parks and Gardens Tour</h1>
      <img
        src="https://www.go2know.de/wp-content/uploads/2020/03/sakura-kirschbluete-berlin-bornholmer-strasse-bluetenpracht-mauerweg-boese-bruecke.jpg"
        alt="Parks Tour"
        className="w-full h-64 object-cover mb-6"
      />
      <p className="text-gray-600 mb-4">
        Experience the beauty of Berlin's best parks and gardens! This tour takes you through lush green spaces and beautiful cherry blossoms in the spring.
      </p>
      ...
      <p className="text-gray-600 mb-4">Meet at Tempelhofer Feld, Tempelhofer Damm, 12099 Berlin</p>
